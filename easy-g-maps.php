...
// Load plugin classes.
require_once EGM_DIR . 'includes/class-settings.php';
require_once EGM_DIR . 'includes/class-admin-hooks.php';
require_once EGM_DIR . 'includes/class-renderer.php';
require_once EGM_DIR . 'includes/class-frontend.php';
require_once EGM_DIR . 'includes/class-shortcode.php';
require_once EGM_DIR . 'includes/class-block.php';
